export const PROJECT_TYPE_HIERARCHY = [
  {
    category: "Центры помощи",
    items: ["Гуманитарный центр", "Центр помощи семье/женщинам/детям", "Консультационный центр", "Центр ресоциализации"]
  },
  {
    category: "Приюты и проживание",
    items: ["Приют (для бездомных, мам с детьми, подростков)", "Богадельня", "Хоспис", "Дом сопровождаемого проживания", "Пункт обогрева"]
  },
  {
    category: "Службы и выезды",
    items: ["Патронажная служба", "Служба добровольцев", "Сестричество милосердия", "Выездная служба", "Автобус милосердия"]
  },
  {
    category: "Питание",
    items: ["Благотворительная столовая", "Пункт кормления"]
  },
  {
    category: "Медицина",
    items: ["Больничный священник", "Медицинский стационар/кабинет"]
  },
  {
    category: "Работа с зависимыми",
    items: ["Реабилитационный центр", "Община/Братство трезвости", "Амбулаторная программа"]
  },
  {
    category: "Образование и клубы",
    items: ["Школа приемных родителей", "Родительский/Семейный клуб"]
  }
];

export const PROJECT_TYPES = PROJECT_TYPE_HIERARCHY.flatMap(c => c.items);

export const CATEGORY_HIERARCHY = [
  {
    category: "Семья и детство",
    items: ["Беременные женщины", "Семьи (многодетные, неполные)", "Дети-сироты", "Профилактика абортов"]
  },
  {
    category: "Здоровье и ОВЗ",
    items: ["Люди с ОВЗ (взрослые и дети)", "Глухие и слабослышащие", "Слепые и слепоглухие", "Паллиативные больные", "Пациенты медучреждений"]
  },
  {
    category: "Трудная жизненная ситуация",
    items: ["Бездомные", "Малоимущие", "Мигранты/беженцы", "Пострадавшие при ЧС"]
  },
  {
    category: "Зависимости",
    items: ["Алкоголезависимые", "Наркозависимые", "Их родственники (созависимые)"]
  },
  {
...
export const CATEGORIES = CATEGORY_HIERARCHY.flatMap(c => c.items);

export const HELP_TYPE_HIERARCHY = [
  {
    category: "Материальная",
    items: ["Продуктовая помощь", "Вещевая помощь", "Финансовая помощь", "Средства реабилитации и ухода"]
  },
  {
    category: "Бытовая и уход",
    items: ["Уход за больными", "Помывка", "Прачечная", "Социальное сопровождение", "Помощь с детьми"]
  },
  {
    category: "Жилье и еда",
    items: ["Предоставление проживания", "Горячее питание", "Обогрев"]
  },
  {
    category: "Консультативная",
    items: ["Юридическая помощь", "Психологическая помощь", "Помощь в трудоустройстве и получении образования"]
  },
  {
    category: "Духовная",
    items: ["Таинства", "Беседы", "Молебны", "Духовное окормление", "Катехизация"]
  },
  {
    category: "Реабилитация",
    items: ["Группы поддержки", "12 шагов", "Медицинская реабилитация"]
  }
];

export const HELP_TYPES = HELP_TYPE_HIERARCHY.flatMap(c => c.items);

export const REGIONS = [
  "Москва", "Санкт-Петербург", "Свердловская область", "Нижегородская область", 
  "Новосибирская область", "Ростовская область", "Московская область", 
  "Ленинградская область", "Краснодарский край", "Красноярский край", 
  "Татарстан", "Самарская область", "Башкортостан", "Челябинская область", 
  "Воронежская область", "Волгоградская область", "Пермский край", 
  "Омская область", "Саратовская область", "Тюменская область", 
  "Иркутская область", "Хабаровский край", "Алтайский край", 
  "Оренбургская область", "Кемеровская область"
];

export const EPARCHIES = [
  "Московская (городская) епархия", "Московская (областная) епархия", "Санкт-Петербургская епархия",
  "Нижегородская епархия", "Екатеринбургская епархия", "Ростовская-на-Дону епархия",
  "Новосибирская епархия", "Екатеринодарская епархия", "Красноярская епархия",
  "Казанская епархия", "Самарская епархия", "Уфимская епархия", "Челябинская епархия",
  "Воронежская епархия", "Волгоградская епархия", "Пермская епархия",
  "Омская епархия", "Саратовская епархия", "Тобольская епархия",
  "Иркутская епархия", "Хабаровская епархия", "Барнаульская епархия",
  "Оренбургская епархия", "Кемеровская епархия"
];
