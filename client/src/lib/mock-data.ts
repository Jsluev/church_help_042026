export const PROJECT_TYPE_HIERARCHY = [
  {
    category: "Питание",
    items: ["Питание бездомных", "Фудшеринг (Фудбоксы)", "Социальные столовые", "Горячие обеды на дом", "Продуктовые наборы"]
  },
  {
    category: "Проживание и приюты",
    items: ["Кризисные центры для женщин", "Приюты для бездомных", "Дома трудолюбия", "Социальные гостиницы", "Богадельни"]
  },
  {
    category: "Медицина и уход",
    items: ["Паллиативная помощь", "Сестричества милосердия", "Медицинская помощь бездомным", "Уход за пожилыми на дому", "Помощь инвалидам"]
  },
  {
    category: "Работа с зависимыми",
    items: ["Реабилитационные центры", "Амбулаторная программа", "Группы поддержки", "Профилактика зависимостей", "Помощь созависимым"]
  },
  {
    category: "Образование и развитие",
    items: ["Школы приемных родителей", "Творческие мастерские", "Спортивные секции для ОВЗ", "Летние лагеря", "Профориентация подростков"]
  }
];
